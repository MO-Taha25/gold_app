...
class _MyHomePageState extends State<MyHomePage1> {
  ...
  final List<Stock> stocks = [
    ...
    Stock(symbol: 'Nasdaq Composite', value: 15579.82, change: -0.11, color: Colors.red),
    Stock(symbol: '500 ETF', value: 4945.09, change: 0.046, color: Colors.green),
    Stock(symbol: 'مؤشر تاسي السعودي', value: 38465.45, change: 0.22, color: Colors.green),
  ];
